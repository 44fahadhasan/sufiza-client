...
const Button = ({ label, style }) => {
  return (
    <span
      className={`${
        style ? style : "text-gray-900 hover:text-white"
      } py-1.5 px-4 relative group overflow-hidden font-medium bg-transparent inline-block uppercase rounded-sm  border-[#7e6e2a] border hover:border-[#7e6e2a] bg-[#7e6e2a]  `}
    >
